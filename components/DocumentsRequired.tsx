      ...
      <div className="max-w-8xl mx-auto px-5 md:px-10 lg:px-24">
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-16 gap-6">
          <div className="flex-1">
            ...
            <p className="text-lg text-[#666] max-w-2xl">
              Simple documentation process. Have these documents ready for a
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {documents.map((doc, index) => (
            ...
            >
              ...
              {/* Icon */}
              <div
                className={`w-20 h-20 bg-gradient-to-br ${doc.iconBg} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
          ...
          <div className="bg-gradient-to-br from-[#0A2745]/5 to-[#0A2745]/10 border border-[#0A2745]/20 rounded-2xl p-6">
            <h4 className="text-lg font-bold text-gray-dark mb-3 flex items-center gap-2">
              ...
              Why Choose ez wealth?
            </h4>
            <ul className="space-y-2 text-sm text-[#666]">
              <li className="flex items-start gap-2">
                <span className="text-[#00D09C] mt-1">✓</span>
                <span>
                  <strong>100% Digital:</strong> No paperwork required
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#00D09C] mt-1">✓</span>
                <span>
                  <strong>Zero AMC:</strong> Lifetime free demat account
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#00D09C] mt-1">✓</span>
                <span>
                  <strong>Quick Approval:</strong> Account activated instantly
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#00D09C] mt-1">✓</span>
                <span>
                  <strong>Secure:</strong> Bank-grade encryption & security
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-[#666]">
            💡 <strong>Note:</strong> Income proof is required only if you want
            to trade in F&O and Commodity segments.
            <br />
