...
import { FaUsers, FaMobileAlt, FaExchangeAlt, FaChartLine, FaShieldAlt, FaRocket, FaBolt, FaAward } from 'react-icons/fa';
...
const features: Feature[] = [
  {
    ...
    description: 'Join over 1 million active traders and investors who trust EZWealth for their financial journey. Rated 4.5+ on app stores.',
  ...
  },
  {
    ...
    description: 'Trade anywhere, anytime with our powerful mobile app and web platform. Seamless experience across all devices.',
  ...
  },
  {
    ...
    description: 'Effortlessly switch between Trading and Investment modes. Optimize your strategy with dedicated interfaces for each.',
  ...
  },
  {
    ...
    description: 'Advanced charts, real-time data, options strategy builder, and TradingView integration. Everything you need to succeed.',
...
const additionalBenefits = [
  ...
  },
  {
    ...
    description: 'Execute trades in milliseconds with our robust infrastructure',
  },
  {
    id: 3,
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-16 gap-6">
          <div className="flex-1">
            <div className="inline-flex items-center gap-2 bg-[#EF9309]/10 rounded-full px-4 py-2 mb-4">
              ...
              <span className="text-sm font-semibold text-[#EF9309]">Why EZWealth</span>
            </div>
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-dark mb-4">
              Why Open Demat Account{' '}
              <span className="block mt-2 bg-gradient-to-r from-[#EF9309] to-[#00D09C] bg-clip-text text-transparent">
                with EZWealth?
              </span>
            </h2>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative mb-6">
                <div className={`w-16 h-16 bg-gradient-to-br ${feature.iconBg} rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                ...
                {feature.stats && (
                  <div className="absolute -top-2 -right-2 bg-white border-2 border-[#EF9309] rounded-full px-3 py-1 shadow-lg">
                    <span className="text-xs font-bold text-[#EF9309]">{feature.stats}</span>
                  </div>
                )}
              </div>
