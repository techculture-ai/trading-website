...
const userFirstFeatures: Feature[] = [
  { icon: 'https://stock-logos.dhan.co/static-openweb/homefold-1.svg', subtitle: '', title: 'No Calls' },
  { icon: 'https://stock-logos.dhan.co/static-openweb/homefold-3.svg', subtitle: '', title: 'No SMS' },
  { icon: 'https://stock-logos.dhan.co/static-openweb/homefold-5.svg', subtitle: '', title: 'No Spam' },
  { icon: 'https://stock-logos.dhan.co/static-openweb/homefold-2.svg', subtitle: '', title: 'No Trading & Investment Advice' },
  { icon: 'https://stock-logos.dhan.co/static-openweb/homefold-4.svg', subtitle: '', title: 'No Relationship Managers' },
  { icon: 'https://stock-logos.dhan.co/static-openweb/homefold-6.svg', subtitle: '', title: 'No Data Sharing' },
];
...
const FeatureItem = ({ f }: { f: Feature }) => (
  <div className="flex gap-3 items-start">
    ...
    <div>
      ...
      <div className="text-[#4F4F4F] font-medium lg:text-lg text-sm">{f.title}</div>
    </div>
  </div>
);
...
export default function TradingFeatures() {
  return (
    ...
    //               <button className="bg-[#EF9309] text-white px-6 py-2 rounded-md shadow-md hover:bg-[#D68108] transition">
    //                 Explore All &nbsp;➜
    //               </button>
    //             </a>
    //           </div>
